...
const
  ...
  graphFavoriters* = gql / "mDc_nU8xGv0cLRWtTaIEug/Favoriters"
  graphRetweeters* = gql / "RCR9gqwYD1NEgi9FWzA50A/Retweeters"
  graphFollowers* = gql / "EAqBhgcGr_qPOzhS4Q3scQ/Followers"
  graphFollowing* = gql / "JPZiqKjET7_M1r5Tlr8pyA/Following"
  favorites* = gql / "eSSNbhECHHWWALkkQq-YTA/Likes"
